...
public class Viajepre extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        RecyclerView rv = (RecyclerView) inflater.inflate(R.layout.fragment_viajepre, container, false);
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        if(Viajepre.this.getArguments().getInt("type") == 2)
        {
        ...
        recyclerView.setAdapter(new ViajeListFragment.ViajesRecyclerViewAdapter(recyclerView,(viajes)));
    }

    public static class ViajesRecyclerViewAdapter
            extends RecyclerView.Adapter<ViajeListFragment.ViajesRecyclerViewAdapter.ViewHolder> {
        ...
        @Override
        public ViajeListFragment.ViajesRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.viaje_item, parent, false);




            return new ViajeListFragment.ViajesRecyclerViewAdapter.ViewHolder(view);
        }

        @Override
        public void onViewRecycled(ViajeListFragment.ViajesRecyclerViewAdapter.ViewHolder holder) {
            /*
...
//                ((BitmapDrawable) holder.mImageView.getTopLevelDrawable()).getBitmap().recycle();
        ...
        @Override
        public void onBindViewHolder(final ViajeListFragment.ViajesRecyclerViewAdapter.ViewHolder holder, final int position) {
